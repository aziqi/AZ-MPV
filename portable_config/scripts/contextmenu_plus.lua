--[[
DOCS_ contextmenu_plus.conf
DOCS_ input_contextmenu_plus.conf
...
Simplified menu authoring: https://mpv.io/manual/master/#context-menu
Available special variables reference: https://github.com/tsl0922/mpv-menu-plugin/wiki/Scripting
...
-- Reason: First version to add context menu support for win32
local min_major = 0
local min_minor = 38
local min_patch = 0
